...
public class SuyamvaramRestController {
	...
	/*@RequestMapping(value = "/login/{username}/{passwrod}")
	public @ResponseBody User login(@PathVariable String username,@PathVariable String passwrod){
...
@RequestMapping(value = "/LoginService", method = RequestMethod.POST)
	public ResponseEntity<LoginResponse> LoginService(@RequestBody User user) {
		LoginResponse loginResponse= new LoginResponse();
	    if (user != null) {
	    	
	        if( user.getUsername().equalsIgnoreCase("Saravanan")) {
	        	
	        	loginResponse.setLoginStatus("Authorised");
	        }else {
	    	...
	    	loginResponse.setLoginStatus("NoInput");
	    	 return new ResponseEntity<LoginResponse>(loginResponse, HttpStatus.OK);
